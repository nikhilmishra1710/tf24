...
const ClubEvents = ({ name, description, image, events, id, lead, coLead, phone }) => {
    ...
    return (
        <div className="w-[100vw] lg:h-[135vh] md:h-[100vh] h-[120vh] flex flex-col px-0 md:px-16 text-white orbitron" id={id}>
            ...
            <div className=" lg:h-[35vh] md:h-[30vh] h-[30vh] w-full flex justify-between mt-14">
                <div className="h-full w-full items-start justify-between px-10 flex text-white">
                    <div className="h-fit w-[40%] flex flex-col-reverse lg:flex-row items-center justify-center md:justify-start">
                        ...
                        <div>
                            <p className="flex flex-col frontman leading-10 tracking-wider text-lg md:text-4xl uppercase break-words md:mr-5 font-light">{name}</p>
...
const EventCard = ({ image, name, description, prize, date, link }) => {
    ...
    return (
        <div
            className="relative h-[62vh] md:h-[90vh] lg:h-[100%] w-[100%] md:w-[10rem] lg:w-[44%] flex flex-none flex-col items-center glass-morph card lg:px-0 clip-path overflow-hidden border-none"
            style={{
                "--x": `${coords.x}px`,
                "--y": `${coords.y}px`,
            }}
