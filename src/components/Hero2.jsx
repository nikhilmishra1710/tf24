...
function Hero() {
    ...
    return (
        <>
            <motion.div className="relative h-screen w-screen max-w-[1720px] bg-red-500" variants={containerVariants} initial="hidden" animate="visible">
                <div className="hazy absolute h-full w-full bg-blue-500"></div>
